                    ...
                    <div class="mail-box">
                        <aside class="sm-side">
                            ...
                            <ul class="inbox-nav inbox-divider">
                                <li class="active">
                                    <a href="#"><i class="fa fa-inbox"></i> Inbox <span class="badge badge-danger pull-right">2</span></a>
                                ...
                                <li>
                                    <a href="#"><i class=" fa fa-external-link"></i> Drafts <span class="badge badge-info pull-right">30</span></a>
                                </li>
                                <li>
