            ...
            @if(Auth::user()->hasRole('admin'))
                @if ($inquires->id_paquetes == 0 AND $inquires->estado == 3)
                    <tr class='unread'>
                        ...
                        <td class="view-message  dont-show"><a href="{{route('del_send_path', [$inquires->id, 0])}}" class="hover-underline">{{$inquires->email}} X {{$inquires->traveller}}</a></td>
                ...
                @elseif($inquires->id_paquetes AND $inquires->estado == 3)
                    @foreach($package->where('id', $inquires->id_paquetes) as $packages)
                        <tr class='unread'>
                            ...
                            <td class="inbox-small-cells"><i class="fa fa-star inbox-started"></i></td>
                            <td class="view-message  dont-show"><a href="{{route('del_send_path', [$inquires->id, $packages->id])}}" class="hover-underline">{{$inquires->email}} X {{$inquires->traveller}}</a></td>
            ...
            @else
                @if ($inquires->id_paquetes == 0 AND $inquires->idusuario == Auth::user()->id AND $inquires->estado == 3)
                    <tr class='unread'>
                        ...
                        <td class="inbox-small-cells"><i class="fa fa-star inbox-started"></i></td>
                        <td class="view-message  dont-show"><a href="{{route('del_send_path', [$inquires->id, 0])}}" class="hover-underline">{{$inquires->email}} X {{$inquires->traveller}}</td></a>
                        <td class="view-message font-weight-light font-italic">Sin paquete seleccionado</td>
                        <td class="view-message  inbox-small-cells"><span class="badge {{$badged}}">{{$inquires->usuario->name}}</span></td>
                        <td class="view-message  text-right">{{$inquires->time}}</td>
                    </tr>
                @elseif ($inquires->id_paquetes > 0 AND $inquires->idusuario == Auth::user()->id AND $inquires->estado == 3)
                    ...
                    @foreach($package->where('id', $inquires->id_paquetes) as $packages)
                        <tr class='unread'>
                            ...
                            <td class="inbox-small-cells"><i class="fa fa-star inbox-started"></i></td>
                            <td class="view-message  dont-show"><a href="{{route('del_send_path', [$inquires->id, $packages->id])}}" class="hover-underline">{{$inquires->email}} X {{$inquires->traveller}}</td></a>
                            <td class="view-message ">{{ucwords($packages->codigo)}}: {{ucwords(strtolower($packages->titulo))}} | {{$inquires->duration}} days</td>
                            <td class="view-message  inbox-small-cells"><span class="badge {{$badged}}">{{$inquires->usuario->name}}</span></td>
                            <td class="view-message  text-right">{{$inquires->time}}</td>
                        </tr>
